    ...
    <div style="margin: 30px;">
        <table class="tab table table-bordered" style="width: 400px;">
            ...
            <tr>
                <th width="100">사원명</th>
                <td>
                    <input type="text" class="form-control" style="width: 150px;" required name="sname" autofocus value="<%=dto.getSname()%>">
                </td>
            </tr>
            <tr>
                <th width="100">사진</th>
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="sbirth" max="2025" class="form-control" required value="<%=dto.getSbirth()%>">
                </td>
            </tr>
            <tr>
                <th width="100">혈액형</th>
