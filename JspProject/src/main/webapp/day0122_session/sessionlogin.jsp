            ...
            <table class="table table-bordered" style="width: 300px;">
                <tr>
                    <td colspan="2" align="center">
                        <label>
                            <input type="checkbox" name="chksave" <%= chksave == null ? "" : "checked" %>>아이디저장
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="myid" class="form-control" placeholder="아이디" autofocus value="<%= myid %>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" class="table-danger" align="center">
                        <button type="submit" class="btn btn-default" style="width: 150px;">회원로그인</button>
                    </td>
                </tr>
            </table>
        </form>
