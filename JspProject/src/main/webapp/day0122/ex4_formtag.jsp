    ...
    <form action="./ex4_action.jsp" method="post">
        <table class="table table-bordered" style="width: 300px;">
            ...
            <tr>
                <th width="100">이름</th>
                <td>
                    <input type="text" name="myname" class="form-control" required="required" value="한가인">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th width="100">주거지</th>
                <td>
                    <label><input type="radio" name="homeaddr" value="서울" checked="checked">서울</label>
                    <label><input type="radio" name="homeaddr" value="경기도">경기도</label>
                    <br>
                    <label><input type="radio" name="homeaddr" value="제주도">제주도</label>
                    <label><input type="radio" name="homeaddr" value="부산">부산</label>
                </td>
            </tr>
            <tr>
                <th width="100">취미</th>
            ...
            <tr>
                <td colspan="2" align="center">
                    <input type="image" value="서버에전송" src="../image/mycar/mycar13.png" style="width:100px;">
                </td>
            </tr>
        </table>
    </form>
